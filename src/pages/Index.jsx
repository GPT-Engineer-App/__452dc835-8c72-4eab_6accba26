...
const Index = () => {
  const [username, set사용자이름] = useState("");
    ...
    <Flex height="100vh" alignItems="center" justifyContent="center">
      <Box p={8} maxWidth="500px" borderWidth={1} borderRadius={8} boxShadow="lg">
        ...
        <Box my={4} textAlign="left">
          <form onSubmit={handle로그인}>
            <FormControl isRequired>
              <FormLabel>사용자 이름</FormLabel>
              <Input type="text" placeholder="사용자 이름 입력" value={username} onChange={(event) => set사용자이름(event.currentTarget.value)} />
            </FormControl>
            <FormControl isRequired mt={6}>
              <FormLabel>비밀번호</FormLabel>
              <Input type="password" placeholder="비밀번호 입력" value={password} onChange={(event) => set비밀번호(event.currentTarget.value)} />
            </FormControl>
